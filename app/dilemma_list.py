...
class Dilemma:
    ...
    def __init__(self, title, description, a, b, c, d, v, n):
        Dilemma.id_counter += 1
        self.id = Dilemma.id_counter
        self.title = title
